// this class acts as the function for placing the red player's chips

public class MoveRed {
    ...
    public void move(int play, char[][] frame) {
        ...
        while (valid == true) {
            ...
            // else statement that only runs when a location is valid, returns with player 1's move
            else {
                frame[row][play] = 'R';
                break;
        }
